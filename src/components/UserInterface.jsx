...
class UserInterface extends React.Component {
    ...
    postConcordance(){
        ...
        fetch('http://localhost:8080/mscs721/concordance/1.0.0/analyze', requestOptions)
          .then(response => {
            this.setState({
    ...
    postLocation(){
        ...
        fetch('http://localhost:8080/mscs721/concordance/1.0.0/locate', requestOptions)
            .then(response => {
                this.setState({
        ...
        return (
            <div>
                <div>
                  ...
                  <br></br>
                  <input type="text" id="concordance" name="concordance" onChange={e => this.onAnalyzeTextChange}/>
                ...
                <div>
                  ...
                  <br></br>
                  <input type="text" id="locator" name="locator" onChange={e => this.onLocationTextChange}/>
